...
(function(){
 ...
 function normalizeEditModal(){
  ...
  var gc=document.getElementById('rgtaCompra'),gn=document.getElementById('rnotaCompra');if(gc)gc.value=(document.getElementById('rgta')||{}).value||'';if(gn)gn.value=(document.getElementById('rnota')||{}).value||'';var cv=document.getElementById('rcategoriaVenda'),cc=document.getElementById('rcategoria');if(cv&&cc)cv.value=cc.value||'';var wv=document.getElementById('rpesoVenda');if(wv)wv.value=r&&r.pesoVendaKg!=null?r.pesoVendaKg:'';
