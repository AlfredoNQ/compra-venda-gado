...
(function(){
  ...
  window.addEventListener('pageshow',function(){setTimeout(function(){try{if(!window.__freshLoginRequired&&window.syncPendingNow)window.syncPendingNow(true);}catch(e){}},250);});
})();
