/* Compra e Venda de Gado — v96 fixes */
(function(){
  window.APP_WEB_VERSION='96';
  ...
  function forceVersion(){try{document.body.setAttribute('data-app-version','96');document.title='Compra e Venda de Gado — v96';var h=document.querySelector('header h1');if(h){var spans=h.querySelectorAll('span');var found=false;spans.forEach(function(s){if(/^v\d+$/i.test((s.textContent||'').trim())){s.textContent='v96';found=true;}});if(!found){var b=document.createElement('span');b.textContent='v96';b.style.cssText='font-size:12px;font-weight:800;padding:3px 7px;border-radius:999px;background:rgba(255,255,255,.16);vertical-align:middle;white-space:nowrap;margin-left:6px';h.appendChild(b);}}}catch(e){}}
